...
<html xml:lang="${cmsfn.language()}" lang="${cmsfn.language()}">
  <head>
    ...
    [#-- To load resources you can link them manually (e.g. line below) --]
      [#-- <link rel="stylesheet" type="text/css" href="${ctx.contextPath}/.resources/vue-contacts/webresources/css/bootstrap.css" media="all" /> --]
      [#-- <script src="${ctx.contextPath}/.resources/vue-contacts/webresources/js/jquery.js"></script> --]
    [#-- or via theme --]
    ...
    [#-- uncomment next line to use resfn templating functions to load all css which matches a globbing pattern --]
      [#-- ${resfn.css(["/vue-contacts/.*css"])!} --]

      ${resfn.js(["/vue-contacts/webresources/js/.*vue.min.js", "/vue-contacts/webresources/js/.*js"])!}
  </head>
  <body class="vue-home ${cmsfn.language()}">


    [#-- use resfn to load all js which matches the globbing pattern or link resources manually or via theme --]
    [#-- ${resfn.js(["/vue-contacts/.*js"])!} --]
[@cms.area name="main"/]
  </body>
</html>
