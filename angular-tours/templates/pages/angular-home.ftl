...
<html xml:lang="${cmsfn.language()}" lang="${cmsfn.language()}">
  <head>
    ...
    [#-- To load resources you can link them manually (e.g. line below) --]
      [#-- <link rel="stylesheet" type="text/css" href="${ctx.contextPath}/.resources/angular-tours/webresources/css/bootstrap.css" media="all" /> --]
      [#-- <script src="${ctx.contextPath}/.resources/angular-tours/webresources/js/jquery.js"></script> --]
    [#-- or via theme --]
    ...
    [#-- uncomment next line to use resfn templating functions to load all css which matches a globbing pattern --]
      [#-- ${resfn.css(["/angular-tours/.*css"])!} --]
  </head>
  <body class="angular-home ${cmsfn.language()}">

${resfn.js(["/angular-tours/webresources/js/.*angular.min.js",
            "/angular-tours/webresources/js/.*js"])!}
[@cms.area name="main" /]
[@cms.area name="tours" /]
    [#-- use resfn to load all js which matches the globbing pattern or link resources manually or via theme --]
    [#-- ${resfn.js(["/angular-tours/.*js"])!} --]
  </body>
</html>
